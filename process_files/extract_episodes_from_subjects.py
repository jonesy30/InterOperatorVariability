...
def extract_episodes_from_subjects(subjects_root_path="./data/root/"):
    ...
    var_map = read_itemid_to_variable_map(os.path.join(os.path.dirname(__file__),"../support_files/itemid_to_variable_map.csv"))
    ...
    for subject_dir in tqdm(os.listdir(subjects_root_path), desc='Iterating over subjects'):
        ...
        try:
            ...
            diagnoses = read_diagnoses(os.path.join(subjects_root_path, subject_dir))
